...
class VPTTrainingPipeline:
    ...
    def _train_epochs(self):
        ...
        vpt_dir = os.path.join(self.run_dir, 'vpt')
        ...
        for epoch_idx in range(1, epochs_total + 1):
            self._run_epoch(epoch_idx, epochs_total, train_loader, vpt_dir)

        self._save_checkpoint()

    def _run_epoch(self, epoch_idx, epochs_total, train_loader, vpt_dir):
        if self.trainer is None:
        ...
        epoch_dir = os.path.join(vpt_dir, f'epoch_{epoch_idx:03d}')
