uv run tip_adapter.py --config configs/tip_adapter_protofuse.yaml \
...
uv run proto_adapter.py --config configs/proto_adapter_protofuse.yaml \
--data.root "${FOOD_DATA_ROOT}" --data.dataset_name "Food-101" \
--data.kshot 1 --data.seed 1
...
uv run ape.py --config configs/ape_protofuse.yaml \
--data.root "${FOOD_DATA_ROOT}" --data.dataset_name "Food-101" \
--data.kshot 1 --data.seed 1
...
uv run timo.py --config configs/timo_protofuse.yaml \
--data.root "${FOOD_DATA_ROOT}" --data.dataset_name "Food-101" \
--data.kshot 1 --data.seed 1
...
uv run timos.py --config configs/timos_protofuse.yaml \
--data.root "${FOOD_DATA_ROOT}" --data.dataset_name "Food-101" \
--data.kshot 1 --data.seed 1
...
uv run protofuse.py --config configs/protofuse_protofuse.yaml \
--data.root "${FOOD_DATA_ROOT}" --data.dataset_name "Food-101" \
--data.kshot 1 --data.seed 1
