...
from maple import MaPLe, MaPLeTrainingPipeline
...
class FixMatchMaPLeTrainingPipeline(MaPLeTrainingPipeline, FixMatchMixin):
    ...
    def run(self):
        ...
        log_experiment_start("FixMatch-MaPLe", dataset_name, self.kshot)
...
def parse_args():
    parser = create_argument_parser("Train FixMatch-MaPLe model", ARG_SCHEMA)
